...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3ArchiveSource.S3ArchiveSourceDefaultDateFormatsOutputReference")
public class S3ArchiveSourceDefaultDateFormatsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3ArchiveSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3ArchiveSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.s3_archive_source.S3ArchiveSourceDefaultDateFormats value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3ArchiveSource.S3ArchiveSourceFiltersList")
public class S3ArchiveSourceFiltersList extends com.hashicorp.cdktf.ComplexList {

    protected S3ArchiveSourceFiltersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3ArchiveSourceFiltersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public S3ArchiveSourceFiltersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.s3_archive_source.S3ArchiveSourceFiltersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_archive_source.S3ArchiveSourceFiltersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.s3_archive_source.S3ArchiveSourceFilters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

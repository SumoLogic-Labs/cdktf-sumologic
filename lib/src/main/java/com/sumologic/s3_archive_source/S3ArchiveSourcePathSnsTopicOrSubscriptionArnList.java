...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3ArchiveSource.S3ArchiveSourcePathSnsTopicOrSubscriptionArnList")
public class S3ArchiveSourcePathSnsTopicOrSubscriptionArnList extends com.hashicorp.cdktf.ComplexList {

    protected S3ArchiveSourcePathSnsTopicOrSubscriptionArnList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3ArchiveSourcePathSnsTopicOrSubscriptionArnList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public S3ArchiveSourcePathSnsTopicOrSubscriptionArnList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.s3_archive_source.S3ArchiveSourcePathSnsTopicOrSubscriptionArnOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_archive_source.S3ArchiveSourcePathSnsTopicOrSubscriptionArnOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }

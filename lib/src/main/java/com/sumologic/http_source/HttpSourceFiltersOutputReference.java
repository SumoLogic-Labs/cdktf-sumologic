...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.httpSource.HttpSourceFiltersOutputReference")
public class HttpSourceFiltersOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected HttpSourceFiltersOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected HttpSourceFiltersOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.http_source.HttpSourceFilters value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

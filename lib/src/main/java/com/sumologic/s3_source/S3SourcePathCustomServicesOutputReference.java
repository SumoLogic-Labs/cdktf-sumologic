...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3Source.S3SourcePathCustomServicesOutputReference")
public class S3SourcePathCustomServicesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3SourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3SourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.s3_source.S3SourcePathCustomServices value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

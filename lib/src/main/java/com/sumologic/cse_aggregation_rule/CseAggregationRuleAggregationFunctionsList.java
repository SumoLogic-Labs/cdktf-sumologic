...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseAggregationRule.CseAggregationRuleAggregationFunctionsList")
public class CseAggregationRuleAggregationFunctionsList extends com.hashicorp.cdktf.ComplexList {

    protected CseAggregationRuleAggregationFunctionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseAggregationRuleAggregationFunctionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CseAggregationRuleAggregationFunctionsList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.cse_aggregation_rule.CseAggregationRuleAggregationFunctionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.cse_aggregation_rule.CseAggregationRuleAggregationFunctionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.cse_aggregation_rule.CseAggregationRuleAggregationFunctions> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

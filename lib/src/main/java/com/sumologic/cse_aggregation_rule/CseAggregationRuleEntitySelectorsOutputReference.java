...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.615Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseAggregationRule.CseAggregationRuleEntitySelectorsOutputReference")
public class CseAggregationRuleEntitySelectorsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CseAggregationRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseAggregationRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cse_aggregation_rule.CseAggregationRuleEntitySelectors value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.monitor.MonitorObjPermissionList")
public class MonitorObjPermissionList extends com.hashicorp.cdktf.ComplexList {

    protected MonitorObjPermissionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MonitorObjPermissionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public MonitorObjPermissionList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.monitor.MonitorObjPermissionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.monitor.MonitorObjPermissionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.monitor.MonitorObjPermission> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.monitor.MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateList")
public class MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateList extends com.hashicorp.cdktf.ComplexList {

    protected MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.monitor.MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.monitor.MonitorTriggerConditionsSloBurnRateConditionWarningBurnRateOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.monitor.MonitorTriggerConditionsSloBurnRateConditionWarningBurnRate> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.monitor.MonitorQueriesOutputReference")
public class MonitorQueriesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected MonitorQueriesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MonitorQueriesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.monitor.MonitorQueries value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source sumologic_kinesis_metrics_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:25.059Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.kinesisMetricsSource.KinesisMetricsSource")
public class KinesisMetricsSource extends com.hashicorp.cdktf.TerraformResource {

    protected KinesisMetricsSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KinesisMetricsSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.kinesis_metrics_source.KinesisMetricsSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source sumologic_kinesis_metrics_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public KinesisMetricsSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the KinesisMetricsSource to import. This parameter is required.
     * @param importFromId The id of the existing KinesisMetricsSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.kinesis_metrics_source.KinesisMetricsSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
    ...
    public void putAuthentication(final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthentication value) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public void putPath(final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePath value) {
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthenticationOutputReference getAuthentication() {
        return software.amazon.jsii.Kernel.get(this, "authentication", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthenticationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFiltersList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePathOutputReference getPath() {
        return software.amazon.jsii.Kernel.get(this, "path", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePathOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthentication getAuthenticationInput() {
        return software.amazon.jsii.Kernel.get(this, "authenticationInput", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthentication.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePath getPathInput() {
        return software.amazon.jsii.Kernel.get(this, "pathInput", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePath.class));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.kinesis_metrics_source.KinesisMetricsSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.kinesis_metrics_source.KinesisMetricsSource> {
        /**
        ...
        private final com.sumologic.kinesis_metrics_source.KinesisMetricsSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.kinesis_metrics_source.KinesisMetricsSourceConfig.Builder();
        }
         ...
         */
        public Builder authentication(final com.sumologic.kinesis_metrics_source.KinesisMetricsSourceAuthentication authentication) {
         ...
         */
        public Builder path(final com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePath path) {
         ...
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#automatic_date_parsing KinesisMetricsSource#automatic_date_parsing}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#category KinesisMetricsSource#category}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#cutoff_relative_time KinesisMetricsSource#cutoff_relative_time}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#cutoff_timestamp KinesisMetricsSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.kinesis_metrics_source.KinesisMetricsSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#description KinesisMetricsSource#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#fields KinesisMetricsSource#fields}. This parameter is required.
         */
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.kinesis_metrics_source.KinesisMetricsSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#force_timezone KinesisMetricsSource#force_timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#host_name KinesisMetricsSource#host_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#id KinesisMetricsSource#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#manual_prefix_regexp KinesisMetricsSource#manual_prefix_regexp}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param messagePerRequest Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#message_per_request KinesisMetricsSource#message_per_request}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#multiline_processing_enabled KinesisMetricsSource#multiline_processing_enabled}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#timezone KinesisMetricsSource#timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_metrics_source#use_autoline_matching KinesisMetricsSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.kinesis_metrics_source.KinesisMetricsSource}.
         */
        @Override
        public com.sumologic.kinesis_metrics_source.KinesisMetricsSource build() {
            return new com.sumologic.kinesis_metrics_source.KinesisMetricsSource(
                this.scope,
                this.id,
                this.config.build()
            );

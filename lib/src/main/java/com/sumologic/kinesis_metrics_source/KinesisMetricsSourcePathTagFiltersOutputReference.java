...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.kinesisMetricsSource.KinesisMetricsSourcePathTagFiltersOutputReference")
public class KinesisMetricsSourcePathTagFiltersOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected KinesisMetricsSourcePathTagFiltersOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KinesisMetricsSourcePathTagFiltersOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.kinesis_metrics_source.KinesisMetricsSourcePathTagFilters value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

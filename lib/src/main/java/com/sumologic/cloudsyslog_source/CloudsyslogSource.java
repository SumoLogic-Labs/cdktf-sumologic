...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source sumologic_cloudsyslog_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.478Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudsyslogSource.CloudsyslogSource")
public class CloudsyslogSource extends com.hashicorp.cdktf.TerraformResource {

    protected CloudsyslogSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudsyslogSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.cloudsyslog_source.CloudsyslogSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source sumologic_cloudsyslog_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public CloudsyslogSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.cloudsyslog_source.CloudsyslogSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the CloudsyslogSource to import. This parameter is required.
     * @param importFromId The id of the existing CloudsyslogSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.cloudsyslog_source.CloudsyslogSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.cloudsyslog_source.CloudsyslogSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudsyslog_source.CloudsyslogSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudsyslog_source.CloudsyslogSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudsyslog_source.CloudsyslogSourceFiltersList.class));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.cloudsyslog_source.CloudsyslogSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.cloudsyslog_source.CloudsyslogSource> {
        /**
        ...
        private final com.sumologic.cloudsyslog_source.CloudsyslogSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.cloudsyslog_source.CloudsyslogSourceConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#automatic_date_parsing CloudsyslogSource#automatic_date_parsing}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#category CloudsyslogSource#category}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param contentType Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#content_type CloudsyslogSource#content_type}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#cutoff_relative_time CloudsyslogSource#cutoff_relative_time}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#cutoff_timestamp CloudsyslogSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.cloudsyslog_source.CloudsyslogSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#description CloudsyslogSource#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#fields CloudsyslogSource#fields}. This parameter is required.
         */
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.cloudsyslog_source.CloudsyslogSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#force_timezone CloudsyslogSource#force_timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#host_name CloudsyslogSource#host_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#id CloudsyslogSource#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#manual_prefix_regexp CloudsyslogSource#manual_prefix_regexp}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#multiline_processing_enabled CloudsyslogSource#multiline_processing_enabled}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#timezone CloudsyslogSource#timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudsyslog_source#use_autoline_matching CloudsyslogSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.cloudsyslog_source.CloudsyslogSource}.
         */
        @Override
        public com.sumologic.cloudsyslog_source.CloudsyslogSource build() {
            return new com.sumologic.cloudsyslog_source.CloudsyslogSource(
                this.scope,
                this.id,
                this.config.build()
            );

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.pollingSource.PollingSourceAuthenticationOutputReference")
public class PollingSourceAuthenticationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PollingSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PollingSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PollingSourceAuthenticationOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.polling_source.PollingSourceAuthentication getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.polling_source.PollingSourceAuthentication.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.polling_source.PollingSourceAuthentication value) {

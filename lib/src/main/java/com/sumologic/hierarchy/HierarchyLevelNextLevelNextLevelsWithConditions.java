...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.hierarchy.HierarchyLevelNextLevelNextLevelsWithConditions")
@software.amazon.jsii.Jsii.Proxy(HierarchyLevelNextLevelNextLevelsWithConditions.Jsii$Proxy.class)
public interface HierarchyLevelNextLevelNextLevelsWithConditions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HierarchyLevelNextLevelNextLevelsWithConditions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HierarchyLevelNextLevelNextLevelsWithConditions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HierarchyLevelNextLevelNextLevelsWithConditions> {
        java.lang.String condition;
        java.lang.Object level;

        /**
         * Sets the value of {@link HierarchyLevelNextLevelNextLevelsWithConditions#getCondition}
        ...
        /**
         * Sets the value of {@link HierarchyLevelNextLevelNextLevelsWithConditions#getLevel}
         ...
         * @return a new instance of {@link HierarchyLevelNextLevelNextLevelsWithConditions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HierarchyLevelNextLevelNextLevelsWithConditions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HierarchyLevelNextLevelNextLevelsWithConditions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HierarchyLevelNextLevelNextLevelsWithConditions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("sumologic.hierarchy.HierarchyLevelNextLevelNextLevelsWithConditions"));
        ...
        public final boolean equals(final Object o) {
            ...
            HierarchyLevelNextLevelNextLevelsWithConditions.Jsii$Proxy that = (HierarchyLevelNextLevelNextLevelsWithConditions.Jsii$Proxy) o;

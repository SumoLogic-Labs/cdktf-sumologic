...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseMatchRule.CseMatchRuleSeverityMappingOutputReference")
public class CseMatchRuleSeverityMappingOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CseMatchRuleSeverityMappingOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseMatchRuleSeverityMappingOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CseMatchRuleSeverityMappingOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMapping>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMapping> __cast_cd4240 = (java.util.List<com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMapping>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMapping __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMappingList getMapping() {
        return software.amazon.jsii.Kernel.get(this, "mapping", software.amazon.jsii.NativeType.forClass(com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMappingList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cse_match_rule.CseMatchRuleSeverityMapping getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.cse_match_rule.CseMatchRuleSeverityMapping.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cse_match_rule.CseMatchRuleSeverityMapping value) {

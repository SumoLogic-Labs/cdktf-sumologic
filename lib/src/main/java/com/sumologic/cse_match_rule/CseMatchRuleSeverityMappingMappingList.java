...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseMatchRule.CseMatchRuleSeverityMappingMappingList")
public class CseMatchRuleSeverityMappingMappingList extends com.hashicorp.cdktf.ComplexList {

    protected CseMatchRuleSeverityMappingMappingList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseMatchRuleSeverityMappingMappingList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CseMatchRuleSeverityMappingMappingList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMappingOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMappingOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.cse_match_rule.CseMatchRuleSeverityMappingMapping> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

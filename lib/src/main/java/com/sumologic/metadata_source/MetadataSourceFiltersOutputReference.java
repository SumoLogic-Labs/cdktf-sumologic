...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.metadataSource.MetadataSourceFiltersOutputReference")
public class MetadataSourceFiltersOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected MetadataSourceFiltersOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MetadataSourceFiltersOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.metadata_source.MetadataSourceFilters value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

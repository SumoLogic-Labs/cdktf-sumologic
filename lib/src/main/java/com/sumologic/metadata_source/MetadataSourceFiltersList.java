...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.metadataSource.MetadataSourceFiltersList")
public class MetadataSourceFiltersList extends com.hashicorp.cdktf.ComplexList {

    protected MetadataSourceFiltersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MetadataSourceFiltersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public MetadataSourceFiltersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.metadata_source.MetadataSourceFiltersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.metadata_source.MetadataSourceFiltersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.metadata_source.MetadataSourceFilters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.506Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudtrailSource.CloudtrailSourceDefaultDateFormatsList")
public class CloudtrailSourceDefaultDateFormatsList extends com.hashicorp.cdktf.ComplexList {

    protected CloudtrailSourceDefaultDateFormatsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudtrailSourceDefaultDateFormatsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudtrailSourceDefaultDateFormatsList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormatsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormatsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

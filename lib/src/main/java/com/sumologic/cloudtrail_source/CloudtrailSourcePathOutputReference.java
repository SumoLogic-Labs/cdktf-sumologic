...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.523Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudtrailSource.CloudtrailSourcePathOutputReference")
public class CloudtrailSourcePathOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudtrailSourcePathOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudtrailSourcePathOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudtrailSourcePathOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServices>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServices> __cast_cd4240 = (java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServices>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServices __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFilters> __cast_cd4240 = (java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServicesList getCustomServices() {
        return software.amazon.jsii.Kernel.get(this, "customServices", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServicesList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourcePathSnsTopicOrSubscriptionArnList getSnsTopicOrSubscriptionArn() {
        return software.amazon.jsii.Kernel.get(this, "snsTopicOrSubscriptionArn", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePathSnsTopicOrSubscriptionArnList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFiltersList getTagFilters() {
        return software.amazon.jsii.Kernel.get(this, "tagFilters", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePathTagFiltersList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cloudtrail_source.CloudtrailSourcePath getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePath.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudtrail_source.CloudtrailSourcePath value) {

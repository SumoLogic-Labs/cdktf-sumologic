...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.522Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudtrailSource.CloudtrailSourcePathCustomServicesOutputReference")
public class CloudtrailSourcePathCustomServicesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudtrailSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudtrailSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudtrail_source.CloudtrailSourcePathCustomServices value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

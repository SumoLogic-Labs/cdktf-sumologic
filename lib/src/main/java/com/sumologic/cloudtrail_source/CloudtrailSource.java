...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source sumologic_cloudtrail_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.495Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudtrailSource.CloudtrailSource")
public class CloudtrailSource extends com.hashicorp.cdktf.TerraformResource {

    protected CloudtrailSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudtrailSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.cloudtrail_source.CloudtrailSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source sumologic_cloudtrail_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public CloudtrailSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the CloudtrailSource to import. This parameter is required.
     * @param importFromId The id of the existing CloudtrailSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.cloudtrail_source.CloudtrailSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
    ...
    public void putAuthentication(final @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceAuthentication value) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.cloudtrail_source.CloudtrailSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.cloudtrail_source.CloudtrailSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public void putPath(final @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourcePath value) {
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceAuthenticationOutputReference getAuthentication() {
        return software.amazon.jsii.Kernel.get(this, "authentication", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourceAuthenticationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourceFiltersList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.cloudtrail_source.CloudtrailSourcePathOutputReference getPath() {
        return software.amazon.jsii.Kernel.get(this, "path", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePathOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cloudtrail_source.CloudtrailSourceAuthentication getAuthenticationInput() {
        return software.amazon.jsii.Kernel.get(this, "authenticationInput", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourceAuthentication.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cloudtrail_source.CloudtrailSourcePath getPathInput() {
        return software.amazon.jsii.Kernel.get(this, "pathInput", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudtrail_source.CloudtrailSourcePath.class));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.cloudtrail_source.CloudtrailSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.cloudtrail_source.CloudtrailSource> {
        /**
        ...
        private final com.sumologic.cloudtrail_source.CloudtrailSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.cloudtrail_source.CloudtrailSourceConfig.Builder();
        }
         ...
         */
        public Builder authentication(final com.sumologic.cloudtrail_source.CloudtrailSourceAuthentication authentication) {
         ...
         */
        public Builder path(final com.sumologic.cloudtrail_source.CloudtrailSourcePath path) {
         ...
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#automatic_date_parsing CloudtrailSource#automatic_date_parsing}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#category CloudtrailSource#category}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#cutoff_relative_time CloudtrailSource#cutoff_relative_time}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#cutoff_timestamp CloudtrailSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.cloudtrail_source.CloudtrailSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#description CloudtrailSource#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#fields CloudtrailSource#fields}. This parameter is required.
         */
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.cloudtrail_source.CloudtrailSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#force_timezone CloudtrailSource#force_timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#host_name CloudtrailSource#host_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#id CloudtrailSource#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#manual_prefix_regexp CloudtrailSource#manual_prefix_regexp}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#multiline_processing_enabled CloudtrailSource#multiline_processing_enabled}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#timezone CloudtrailSource#timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/cloudtrail_source#use_autoline_matching CloudtrailSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.cloudtrail_source.CloudtrailSource}.
         */
        @Override
        public com.sumologic.cloudtrail_source.CloudtrailSource build() {
            return new com.sumologic.cloudtrail_source.CloudtrailSource(
                this.scope,
                this.id,
                this.config.build()
            );

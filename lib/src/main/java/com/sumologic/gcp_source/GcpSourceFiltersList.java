...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.gcpSource.GcpSourceFiltersList")
public class GcpSourceFiltersList extends com.hashicorp.cdktf.ComplexList {

    protected GcpSourceFiltersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GcpSourceFiltersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public GcpSourceFiltersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.gcp_source.GcpSourceFiltersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.gcp_source.GcpSourceFiltersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.gcp_source.GcpSourceFilters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

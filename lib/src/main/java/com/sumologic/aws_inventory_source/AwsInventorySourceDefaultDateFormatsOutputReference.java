...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.awsInventorySource.AwsInventorySourceDefaultDateFormatsOutputReference")
public class AwsInventorySourceDefaultDateFormatsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AwsInventorySourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AwsInventorySourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.aws_inventory_source.AwsInventorySourceDefaultDateFormats value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

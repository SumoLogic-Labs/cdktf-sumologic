...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.slo.SloIndicatorWindowBasedEvaluationQueriesQueryGroupList")
public class SloIndicatorWindowBasedEvaluationQueriesQueryGroupList extends com.hashicorp.cdktf.ComplexList {

    protected SloIndicatorWindowBasedEvaluationQueriesQueryGroupList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SloIndicatorWindowBasedEvaluationQueriesQueryGroupList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.slo.SloIndicatorWindowBasedEvaluationQueriesQueryGroupOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.slo.SloIndicatorWindowBasedEvaluationQueriesQueryGroupOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.slo.SloIndicatorWindowBasedEvaluationQueriesQueryGroup> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

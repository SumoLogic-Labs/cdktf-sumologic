...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.slo.SloIndicatorRequestBasedEvaluationQueries")
@software.amazon.jsii.Jsii.Proxy(SloIndicatorRequestBasedEvaluationQueries.Jsii$Proxy.class)
public interface SloIndicatorRequestBasedEvaluationQueries extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SloIndicatorRequestBasedEvaluationQueries}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SloIndicatorRequestBasedEvaluationQueries}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SloIndicatorRequestBasedEvaluationQueries> {
        java.lang.Object queryGroup;
        java.lang.String queryGroupType;

        /**
         * Sets the value of {@link SloIndicatorRequestBasedEvaluationQueries#getQueryGroup}
         ...
         * @return {@code this}
         */
        public Builder queryGroup(java.util.List<? extends com.sumologic.slo.SloIndicatorRequestBasedEvaluationQueriesQueryGroup> queryGroup) {
            this.queryGroup = queryGroup;
            return this;
        }

        /**
         * Sets the value of {@link SloIndicatorRequestBasedEvaluationQueries#getQueryGroupType}
         ...
         * @return a new instance of {@link SloIndicatorRequestBasedEvaluationQueries}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SloIndicatorRequestBasedEvaluationQueries build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SloIndicatorRequestBasedEvaluationQueries}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SloIndicatorRequestBasedEvaluationQueries {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("sumologic.slo.SloIndicatorRequestBasedEvaluationQueries"));
        ...
        public final boolean equals(final Object o) {
            ...
            SloIndicatorRequestBasedEvaluationQueries.Jsii$Proxy that = (SloIndicatorRequestBasedEvaluationQueries.Jsii$Proxy) o;

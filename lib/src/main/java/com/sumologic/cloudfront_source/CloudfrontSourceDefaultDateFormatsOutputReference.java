...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudfrontSource.CloudfrontSourceDefaultDateFormatsOutputReference")
public class CloudfrontSourceDefaultDateFormatsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudfrontSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudfrontSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudfront_source.CloudfrontSourceDefaultDateFormats value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

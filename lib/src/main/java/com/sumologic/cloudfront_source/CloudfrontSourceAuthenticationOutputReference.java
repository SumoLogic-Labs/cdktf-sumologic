...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudfrontSource.CloudfrontSourceAuthenticationOutputReference")
public class CloudfrontSourceAuthenticationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudfrontSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudfrontSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudfrontSourceAuthenticationOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cloudfront_source.CloudfrontSourceAuthentication getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudfront_source.CloudfrontSourceAuthentication.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudfront_source.CloudfrontSourceAuthentication value) {

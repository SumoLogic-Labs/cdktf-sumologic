...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseThresholdRule.CseThresholdRuleEntitySelectorsOutputReference")
public class CseThresholdRuleEntitySelectorsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CseThresholdRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseThresholdRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cse_threshold_rule.CseThresholdRuleEntitySelectors value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

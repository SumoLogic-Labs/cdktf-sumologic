...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source sumologic_kinesis_log_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:25.053Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.kinesisLogSource.KinesisLogSource")
public class KinesisLogSource extends com.hashicorp.cdktf.TerraformResource {

    protected KinesisLogSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KinesisLogSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.kinesis_log_source.KinesisLogSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source sumologic_kinesis_log_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public KinesisLogSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the KinesisLogSource to import. This parameter is required.
     * @param importFromId The id of the existing KinesisLogSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.kinesis_log_source.KinesisLogSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
    ...
    public void putAuthentication(final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourceAuthentication value) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.kinesis_log_source.KinesisLogSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.kinesis_log_source.KinesisLogSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public void putPath(final @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourcePath value) {
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourceAuthenticationOutputReference getAuthentication() {
        return software.amazon.jsii.Kernel.get(this, "authentication", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourceAuthenticationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourceFiltersList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.kinesis_log_source.KinesisLogSourcePathOutputReference getPath() {
        return software.amazon.jsii.Kernel.get(this, "path", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourcePathOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.kinesis_log_source.KinesisLogSourceAuthentication getAuthenticationInput() {
        return software.amazon.jsii.Kernel.get(this, "authenticationInput", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourceAuthentication.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.kinesis_log_source.KinesisLogSourcePath getPathInput() {
        return software.amazon.jsii.Kernel.get(this, "pathInput", software.amazon.jsii.NativeType.forClass(com.sumologic.kinesis_log_source.KinesisLogSourcePath.class));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.kinesis_log_source.KinesisLogSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.kinesis_log_source.KinesisLogSource> {
        /**
        ...
        private final com.sumologic.kinesis_log_source.KinesisLogSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.kinesis_log_source.KinesisLogSourceConfig.Builder();
        }
         ...
         */
        public Builder authentication(final com.sumologic.kinesis_log_source.KinesisLogSourceAuthentication authentication) {
         ...
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#automatic_date_parsing KinesisLogSource#automatic_date_parsing}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#category KinesisLogSource#category}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#cutoff_relative_time KinesisLogSource#cutoff_relative_time}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#cutoff_timestamp KinesisLogSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.kinesis_log_source.KinesisLogSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#description KinesisLogSource#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#fields KinesisLogSource#fields}. This parameter is required.
         */
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.kinesis_log_source.KinesisLogSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#force_timezone KinesisLogSource#force_timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#host_name KinesisLogSource#host_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#id KinesisLogSource#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#manual_prefix_regexp KinesisLogSource#manual_prefix_regexp}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param messagePerRequest Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#message_per_request KinesisLogSource#message_per_request}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#multiline_processing_enabled KinesisLogSource#multiline_processing_enabled}. This parameter is required.
         */
         ...
         */
        public Builder path(final com.sumologic.kinesis_log_source.KinesisLogSourcePath path) {
         ...
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#timezone KinesisLogSource#timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/kinesis_log_source#use_autoline_matching KinesisLogSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.kinesis_log_source.KinesisLogSource}.
         */
        @Override
        public com.sumologic.kinesis_log_source.KinesisLogSource build() {
            return new com.sumologic.kinesis_log_source.KinesisLogSource(
                this.scope,
                this.id,
                this.config.build()
            );

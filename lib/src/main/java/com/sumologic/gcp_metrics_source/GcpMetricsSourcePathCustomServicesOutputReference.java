...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.gcpMetricsSource.GcpMetricsSourcePathCustomServicesOutputReference")
public class GcpMetricsSourcePathCustomServicesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected GcpMetricsSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GcpMetricsSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.gcp_metrics_source.GcpMetricsSourcePathCustomServices value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

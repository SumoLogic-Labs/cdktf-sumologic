...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.649Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cseChainRule.CseChainRuleEntitySelectorsOutputReference")
public class CseChainRuleEntitySelectorsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CseChainRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CseChainRuleEntitySelectorsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cse_chain_rule.CseChainRuleEntitySelectors value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

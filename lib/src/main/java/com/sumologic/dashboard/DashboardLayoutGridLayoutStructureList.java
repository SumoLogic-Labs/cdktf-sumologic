...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.dashboard.DashboardLayoutGridLayoutStructureList")
public class DashboardLayoutGridLayoutStructureList extends com.hashicorp.cdktf.ComplexList {

    protected DashboardLayoutGridLayoutStructureList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DashboardLayoutGridLayoutStructureList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DashboardLayoutGridLayoutStructureList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.dashboard.DashboardLayoutGridLayoutStructureOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.dashboard.DashboardLayoutGridLayoutStructureOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.dashboard.DashboardLayoutGridLayoutStructure> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

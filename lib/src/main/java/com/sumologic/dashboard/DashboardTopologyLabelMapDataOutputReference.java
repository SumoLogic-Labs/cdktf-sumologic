...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.dashboard.DashboardTopologyLabelMapDataOutputReference")
public class DashboardTopologyLabelMapDataOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DashboardTopologyLabelMapDataOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DashboardTopologyLabelMapDataOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.dashboard.DashboardTopologyLabelMapData value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

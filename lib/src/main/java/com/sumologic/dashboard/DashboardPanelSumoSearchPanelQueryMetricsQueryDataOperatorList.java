...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.dashboard.DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorList")
public class DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorList extends com.hashicorp.cdktf.ComplexList {

    protected DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.dashboard.DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.dashboard.DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperatorOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.dashboard.DashboardPanelSumoSearchPanelQueryMetricsQueryDataOperator> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

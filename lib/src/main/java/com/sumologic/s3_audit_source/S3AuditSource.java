...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source sumologic_s3_audit_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:25.164Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3AuditSource.S3AuditSource")
public class S3AuditSource extends com.hashicorp.cdktf.TerraformResource {

    protected S3AuditSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3AuditSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.s3_audit_source.S3AuditSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source sumologic_s3_audit_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public S3AuditSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the S3AuditSource to import. This parameter is required.
     * @param importFromId The id of the existing S3AuditSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.s3_audit_source.S3AuditSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
    ...
    public void putAuthentication(final @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourceAuthentication value) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.s3_audit_source.S3AuditSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.s3_audit_source.S3AuditSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.s3_audit_source.S3AuditSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.s3_audit_source.S3AuditSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public void putPath(final @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourcePath value) {
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourceAuthenticationOutputReference getAuthentication() {
        return software.amazon.jsii.Kernel.get(this, "authentication", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourceAuthenticationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourceFiltersList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourcePathOutputReference getPath() {
        return software.amazon.jsii.Kernel.get(this, "path", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePathOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.s3_audit_source.S3AuditSourceAuthentication getAuthenticationInput() {
        return software.amazon.jsii.Kernel.get(this, "authenticationInput", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourceAuthentication.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.s3_audit_source.S3AuditSourcePath getPathInput() {
        return software.amazon.jsii.Kernel.get(this, "pathInput", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePath.class));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.s3_audit_source.S3AuditSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.s3_audit_source.S3AuditSource> {
        /**
        ...
        private final com.sumologic.s3_audit_source.S3AuditSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.s3_audit_source.S3AuditSourceConfig.Builder();
        }
         ...
         * <p>
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#authentication S3AuditSource#authentication}
         * <p>
         * @return {@code this}
         * @param authentication authentication block. This parameter is required.
         */
        public Builder authentication(final com.sumologic.s3_audit_source.S3AuditSourceAuthentication authentication) {
            this.config.authentication(authentication);
            return this;
        }

        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#collector_id S3AuditSource#collector_id}.
         * <p>
         * @return {@code this}
         * @param collectorId Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#collector_id S3AuditSource#collector_id}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#content_type S3AuditSource#content_type}.
         * <p>
         * @return {@code this}
         * @param contentType Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#content_type S3AuditSource#content_type}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#name S3AuditSource#name}.
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#name S3AuditSource#name}. This parameter is required.
         */
         ...
         * path block.
         * <p>
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#path S3AuditSource#path}
         * <p>
         * @return {@code this}
         * @param path path block. This parameter is required.
         */
        public Builder path(final com.sumologic.s3_audit_source.S3AuditSourcePath path) {
            this.config.path(path);
            return this;
        }

        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#paused S3AuditSource#paused}.
         * <p>
         * @return {@code this}
         * @param paused Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#paused S3AuditSource#paused}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#scan_interval S3AuditSource#scan_interval}.
         * <p>
         * @return {@code this}
         * @param scanInterval Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#scan_interval S3AuditSource#scan_interval}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#automatic_date_parsing S3AuditSource#automatic_date_parsing}.
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#automatic_date_parsing S3AuditSource#automatic_date_parsing}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#category S3AuditSource#category}.
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#category S3AuditSource#category}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#cutoff_relative_time S3AuditSource#cutoff_relative_time}.
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#cutoff_relative_time S3AuditSource#cutoff_relative_time}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#cutoff_timestamp S3AuditSource#cutoff_timestamp}.
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#cutoff_timestamp S3AuditSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * <p>
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#default_date_formats S3AuditSource#default_date_formats}
         * <p>
         * @return {@code this}
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.s3_audit_source.S3AuditSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }

        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#description S3AuditSource#description}.
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#description S3AuditSource#description}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#fields S3AuditSource#fields}.
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#fields S3AuditSource#fields}. This parameter is required.
         */
         ...
         * filters block.
         * <p>
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#filters S3AuditSource#filters}
         * <p>
         * @return {@code this}
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.s3_audit_source.S3AuditSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }

        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#force_timezone S3AuditSource#force_timezone}.
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#force_timezone S3AuditSource#force_timezone}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#host_name S3AuditSource#host_name}.
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#host_name S3AuditSource#host_name}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#id S3AuditSource#id}.
         * <p>
         * Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         * If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#id S3AuditSource#id}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#manual_prefix_regexp S3AuditSource#manual_prefix_regexp}.
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#manual_prefix_regexp S3AuditSource#manual_prefix_regexp}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#multiline_processing_enabled S3AuditSource#multiline_processing_enabled}.
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#multiline_processing_enabled S3AuditSource#multiline_processing_enabled}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#timezone S3AuditSource#timezone}.
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#timezone S3AuditSource#timezone}. This parameter is required.
         */
        ...
        /**
         * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#use_autoline_matching S3AuditSource#use_autoline_matching}.
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/s3_audit_source#use_autoline_matching S3AuditSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.s3_audit_source.S3AuditSource}.
         */
        @Override
        public com.sumologic.s3_audit_source.S3AuditSource build() {
            return new com.sumologic.s3_audit_source.S3AuditSource(
                this.scope,
                this.id,
                this.config.build()
            );

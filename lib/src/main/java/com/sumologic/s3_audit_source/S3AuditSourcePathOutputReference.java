...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:25.170Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3AuditSource.S3AuditSourcePathOutputReference")
public class S3AuditSourcePathOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3AuditSourcePathOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3AuditSourcePathOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public S3AuditSourcePathOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathCustomServices>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathCustomServices> __cast_cd4240 = (java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathCustomServices>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.s3_audit_source.S3AuditSourcePathCustomServices __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathTagFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathTagFilters> __cast_cd4240 = (java.util.List<com.sumologic.s3_audit_source.S3AuditSourcePathTagFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.s3_audit_source.S3AuditSourcePathTagFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourcePathCustomServicesList getCustomServices() {
        return software.amazon.jsii.Kernel.get(this, "customServices", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePathCustomServicesList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourcePathSnsTopicOrSubscriptionArnList getSnsTopicOrSubscriptionArn() {
        return software.amazon.jsii.Kernel.get(this, "snsTopicOrSubscriptionArn", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePathSnsTopicOrSubscriptionArnList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.s3_audit_source.S3AuditSourcePathTagFiltersList getTagFilters() {
        return software.amazon.jsii.Kernel.get(this, "tagFilters", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePathTagFiltersList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.s3_audit_source.S3AuditSourcePath getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.s3_audit_source.S3AuditSourcePath.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.s3_audit_source.S3AuditSourcePath value) {

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.s3AuditSource.S3AuditSourcePathCustomServicesOutputReference")
public class S3AuditSourcePathCustomServicesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3AuditSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3AuditSourcePathCustomServicesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.s3_audit_source.S3AuditSourcePathCustomServices value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.422Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.awsXraySource.AwsXraySourcePathOutputReference")
public class AwsXraySourcePathOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AwsXraySourcePathOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AwsXraySourcePathOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public AwsXraySourcePathOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathCustomServices>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathCustomServices> __cast_cd4240 = (java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathCustomServices>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.aws_xray_source.AwsXraySourcePathCustomServices __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathTagFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathTagFilters> __cast_cd4240 = (java.util.List<com.sumologic.aws_xray_source.AwsXraySourcePathTagFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.aws_xray_source.AwsXraySourcePathTagFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.aws_xray_source.AwsXraySourcePathCustomServicesList getCustomServices() {
        return software.amazon.jsii.Kernel.get(this, "customServices", software.amazon.jsii.NativeType.forClass(com.sumologic.aws_xray_source.AwsXraySourcePathCustomServicesList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.aws_xray_source.AwsXraySourcePathSnsTopicOrSubscriptionArnList getSnsTopicOrSubscriptionArn() {
        return software.amazon.jsii.Kernel.get(this, "snsTopicOrSubscriptionArn", software.amazon.jsii.NativeType.forClass(com.sumologic.aws_xray_source.AwsXraySourcePathSnsTopicOrSubscriptionArnList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.aws_xray_source.AwsXraySourcePathTagFiltersList getTagFilters() {
        return software.amazon.jsii.Kernel.get(this, "tagFilters", software.amazon.jsii.NativeType.forClass(com.sumologic.aws_xray_source.AwsXraySourcePathTagFiltersList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.aws_xray_source.AwsXraySourcePath getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.aws_xray_source.AwsXraySourcePath.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.aws_xray_source.AwsXraySourcePath value) {

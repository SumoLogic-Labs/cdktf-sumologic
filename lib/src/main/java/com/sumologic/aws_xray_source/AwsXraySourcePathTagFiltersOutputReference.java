...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.448Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.awsXraySource.AwsXraySourcePathTagFiltersOutputReference")
public class AwsXraySourcePathTagFiltersOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AwsXraySourcePathTagFiltersOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AwsXraySourcePathTagFiltersOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.aws_xray_source.AwsXraySourcePathTagFilters value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

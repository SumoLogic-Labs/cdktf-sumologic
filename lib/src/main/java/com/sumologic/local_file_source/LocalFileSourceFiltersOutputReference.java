...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.localFileSource.LocalFileSourceFiltersOutputReference")
public class LocalFileSourceFiltersOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LocalFileSourceFiltersOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LocalFileSourceFiltersOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.local_file_source.LocalFileSourceFilters value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

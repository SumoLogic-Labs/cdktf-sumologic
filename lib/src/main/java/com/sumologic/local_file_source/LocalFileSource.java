...
/**
 * Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source sumologic_local_file_source}.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:25.065Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.localFileSource.LocalFileSource")
public class LocalFileSource extends com.hashicorp.cdktf.TerraformResource {

    protected LocalFileSource(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LocalFileSource(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.sumologic.local_file_source.LocalFileSource.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    /**
     * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source sumologic_local_file_source} Resource.
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param id The scoped construct ID. This parameter is required.
     * @param config This parameter is required.
     */
    public LocalFileSource(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.sumologic.local_file_source.LocalFileSourceConfig config) {
     ...
     * <p>
     * @param scope The scope in which to define this construct. This parameter is required.
     * @param importToId The construct id used in the generated config for the LocalFileSource to import. This parameter is required.
     * @param importFromId The id of the existing LocalFileSource that should be imported. This parameter is required.
    ...
    public static @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ImportableResource generateConfigForImport(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String importToId, final @org.jetbrains.annotations.NotNull java.lang.String importFromId, final @org.jetbrains.annotations.Nullable com.hashicorp.cdktf.TerraformProvider provider) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.sumologic.local_file_source.LocalFileSource.class, "generateConfigForImport", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.ImportableResource.class), new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(importToId, "importToId is required"), java.util.Objects.requireNonNull(importFromId, "importFromId is required"), provider });
    }
            ...
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats> __cast_cd4240 = (java.util.List<com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            if (
                ...
                throw new IllegalArgumentException(
                    new java.lang.StringBuilder("Expected ")
                        .append("value")
                        .append(" to be one of: com.hashicorp.cdktf.IResolvable, java.util.List<com.sumologic.local_file_source.LocalFileSourceFilters>; received ")
                        .append(value.getClass()).toString());
            }
            if (value instanceof java.util.List) {
                @SuppressWarnings("unchecked")
                final java.util.List<com.sumologic.local_file_source.LocalFileSourceFilters> __cast_cd4240 = (java.util.List<com.sumologic.local_file_source.LocalFileSourceFilters>)value;
                for (int __idx_ac66f0 = 0; __idx_ac66f0 < __cast_cd4240.size(); __idx_ac66f0++) {
                    final com.sumologic.local_file_source.LocalFileSourceFilters __val_ac66f0 = __cast_cd4240.get(__idx_ac66f0);
                }
            }
        }
    ...
    public void resetDenyList() {
        software.amazon.jsii.Kernel.call(this, "resetDenyList", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull com.sumologic.local_file_source.LocalFileSourceDefaultDateFormatsList getDefaultDateFormats() {
        return software.amazon.jsii.Kernel.get(this, "defaultDateFormats", software.amazon.jsii.NativeType.forClass(com.sumologic.local_file_source.LocalFileSourceDefaultDateFormatsList.class));
    }

    public @org.jetbrains.annotations.NotNull com.sumologic.local_file_source.LocalFileSourceFiltersList getFilters() {
        return software.amazon.jsii.Kernel.get(this, "filters", software.amazon.jsii.NativeType.forClass(com.sumologic.local_file_source.LocalFileSourceFiltersList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<java.lang.String> getDenyListInput() {
        return java.util.Optional.ofNullable((java.util.List<java.lang.String>)(software.amazon.jsii.Kernel.get(this, "denyListInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getDenyList() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "denyList", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }

    public void setDenyList(final @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> value) {
        software.amazon.jsii.Kernel.set(this, "denyList", java.util.Objects.requireNonNull(value, "denyList is required"));
    }
    ...
    /**
     * A fluent builder for {@link com.sumologic.local_file_source.LocalFileSource}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.sumologic.local_file_source.LocalFileSource> {
        /**
        ...
        private final com.sumologic.local_file_source.LocalFileSourceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new com.sumologic.local_file_source.LocalFileSourceConfig.Builder();
        }
         ...
         */
        public Builder pathExpression(final java.lang.String pathExpression) {
            this.config.pathExpression(pathExpression);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param automaticDateParsing Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#automatic_date_parsing LocalFileSource#automatic_date_parsing}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param category Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#category LocalFileSource#category}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param contentType Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#content_type LocalFileSource#content_type}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffRelativeTime Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#cutoff_relative_time LocalFileSource#cutoff_relative_time}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param cutoffTimestamp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#cutoff_timestamp LocalFileSource#cutoff_timestamp}. This parameter is required.
         */
         ...
         * @param defaultDateFormats default_date_formats block. This parameter is required.
         */
        public Builder defaultDateFormats(final java.util.List<? extends com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats> defaultDateFormats) {
            this.config.defaultDateFormats(defaultDateFormats);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param denyList Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#deny_list LocalFileSource#deny_list}. This parameter is required.
         */
        public Builder denyList(final java.util.List<java.lang.String> denyList) {
            this.config.denyList(denyList);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#description LocalFileSource#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param encoding Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#encoding LocalFileSource#encoding}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fields Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#fields LocalFileSource#fields}. This parameter is required.
         */
         ...
         * @param filters filters block. This parameter is required.
         */
        public Builder filters(final java.util.List<? extends com.sumologic.local_file_source.LocalFileSourceFilters> filters) {
            this.config.filters(filters);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param forceTimezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#force_timezone LocalFileSource#force_timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param hostName Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#host_name LocalFileSource#host_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#id LocalFileSource#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param manualPrefixRegexp Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#manual_prefix_regexp LocalFileSource#manual_prefix_regexp}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param multilineProcessingEnabled Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#multiline_processing_enabled LocalFileSource#multiline_processing_enabled}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param timezone Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#timezone LocalFileSource#timezone}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param useAutolineMatching Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/2.29.0/docs/resources/local_file_source#use_autoline_matching LocalFileSource#use_autoline_matching}. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.sumologic.local_file_source.LocalFileSource}.
         */
        @Override
        public com.sumologic.local_file_source.LocalFileSource build() {
            return new com.sumologic.local_file_source.LocalFileSource(
                this.scope,
                this.id,
                this.config.build()
            );

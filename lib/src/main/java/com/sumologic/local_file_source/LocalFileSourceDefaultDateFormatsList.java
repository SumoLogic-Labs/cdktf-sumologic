...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.localFileSource.LocalFileSourceDefaultDateFormatsList")
public class LocalFileSourceDefaultDateFormatsList extends com.hashicorp.cdktf.ComplexList {

    protected LocalFileSourceDefaultDateFormatsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LocalFileSourceDefaultDateFormatsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public LocalFileSourceDefaultDateFormatsList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.sumologic.local_file_source.LocalFileSourceDefaultDateFormatsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.sumologic.local_file_source.LocalFileSourceDefaultDateFormatsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.sumologic.local_file_source.LocalFileSourceDefaultDateFormats> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}

...
@javax.annotation.Generated(value = "jsii-pacmak/1.95.0 (build f1ff514)", date = "2024-04-16T12:34:24.556Z")
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudwatchSource.CloudwatchSourceAuthenticationOutputReference")
public class CloudwatchSourceAuthenticationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudwatchSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudwatchSourceAuthenticationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudwatchSourceAuthenticationOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable com.sumologic.cloudwatch_source.CloudwatchSourceAuthentication getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.sumologic.cloudwatch_source.CloudwatchSourceAuthentication.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudwatch_source.CloudwatchSourceAuthentication value) {

...
@software.amazon.jsii.Jsii(module = com.sumologic.$Module.class, fqn = "sumologic.cloudwatchSource.CloudwatchSourceDefaultDateFormatsOutputReference")
public class CloudwatchSourceDefaultDateFormatsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudwatchSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudwatchSourceDefaultDateFormatsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.sumologic.cloudwatch_source.CloudwatchSourceDefaultDateFormats value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
